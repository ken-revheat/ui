 ...
 */
export const FALLBACK_ICON_PATHS: readonly string[] = ["M3 4h18v12h-11l-7 5z"];

export const PRODUCT_ICON_PATHS: Readonly<Record<string, readonly string[]>> = {
 ...
 */
export function iconPathsFor(code: string): readonly string[] {
