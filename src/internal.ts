 ...
 */
export function inAppHref(href: string): string {
 ...
 */
export function shellNavHandler<E extends ShellClick>(
  href: string,
  navigate: ((href: string) => void) | undefined,
  external?: boolean,
): ((e: E) => void) | undefined {
  if (!navigate || external || !isSameOriginHref(href)) return undefined;
  return (e: E) => {
    if (isModifiedClick(e)) return;
    e.preventDefault();
    navigate(inAppHref(href));
  };
}
