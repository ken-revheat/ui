...
function entitledRowVNode(
  ...
  return h("li", { class: "rh-rail__item", key: p.code }, [
    h(
      "a",
      { class: "rh-rail__link", href, "aria-current": active ? "page" : undefined },
      [
            ...
            ? h("nav", { class: "rh-rail__section", "aria-label": "Your products" }, [
                ...
                h(
                  ...
                  model.entitled.map((p) =>
                    entitledRowVNode(p, props.activePath, props.currentProductCode),
                  ),
                ),
              ])
            : null,
        ...
        h("div", { class: "rh-shell__main" }, [
          h("header", { class: "rh-banner" }, [
            h("div", { class: "rh-banner__lead" }, [
              ...
              h(
                "a",
                { class: "rh-banner__brand", href: `${PORTAL_ORIGIN}/`, "aria-label": "RevHeat home" },
                brandWordmark(),
              ),
                ...
                menuItems.map((s) =>
                  h(
                    "a",
                    {
                      ...
                      onClick:
                        hasNavigate() && !s.external && isSameOriginHref(s.href)
                          ? (e: MouseEvent) => {
